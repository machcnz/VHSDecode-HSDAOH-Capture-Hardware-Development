<!-- TOC -->
* [Repository contents](#this-repo-includes)
* [High level steps to get up and running](#high-level-steps-to-get-up-and-running)
...
This guide assumes a basic understand of the concepts, hardware & software options and usage of the VHS decode's capture
method.

[Otherwise, it's best to start here first](https://github.com/oyvindln/vhs-decode/wiki)
...
- 1x [This](https://github.com/Sev5000/Pico2_12bitADC_PCMAudio/blob/main/Gerber_Pico2_12bitADC.zip) PCB (Send the Gerber
  .zip to JLC, PCBWay, ..)
...
> restored by adding a jumper wire. (flaw 2 image)
